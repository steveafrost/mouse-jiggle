...
exports.default = (0, utils_2.createRule)({
    create: (context, [options = {}]) => {
        var _a;
        const extraFixedCaseWords = (_a = options.extraFixedCaseWords) !== null && _a !== void 0 ? _a : [];
        return {
                    ...
                    if (titleAttribute) {
                        ...
                        if (value) {
                            if (value.type === utils_1.AST_NODE_TYPES.Literal &&
                                ...
                                const formattedTitle = (0, title_case_1.titleCase)(originalTitle, extraFixedCaseWords);
                            ...
                            if (value.type === utils_1.AST_NODE_TYPES.JSXExpressionContainer) {
                                ...
                                if (expression.type === utils_1.AST_NODE_TYPES.Literal &&
                                    ...
                                    const formattedTitle = (0, title_case_1.titleCase)(expression.value, extraFixedCaseWords);
                                ...
                                if (expression.type === utils_1.AST_NODE_TYPES.ConditionalExpression) {
                                    ...
                                    if (consequent.type === utils_1.AST_NODE_TYPES.Literal &&
                                        ...
                                        const formattedTitle = (0, title_case_1.titleCase)(consequent.value, extraFixedCaseWords);
                                    ...
                                    if (alternate.type === utils_1.AST_NODE_TYPES.Literal &&
                                        ...
                                        const formattedTitle = (0, title_case_1.titleCase)(alternate.value, extraFixedCaseWords);
                                ...
                                if (expression.type === utils_1.AST_NODE_TYPES.TemplateLiteral) {
                                    ...
                                    quasis.forEach((quasi) => {
                                        if (quasi.type === utils_1.AST_NODE_TYPES.TemplateElement &&
                                            ...
                                            const formattedTitle = (0, title_case_1.titleCase)(quasi.value.raw, extraFixedCaseWords);
        ...
        schema: [
            {
                ...
                properties: {
                    extraFixedCaseWords: {
                        ...
                        uniqueItems: true,
                        description: "List of additional words to keep in fixed case (e.g. `macOS`, `iPhone`).",
                    },
                },
